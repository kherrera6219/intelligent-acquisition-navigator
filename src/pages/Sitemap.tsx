...
import { ArrowRight, Brain, Shield, Zap, BarChart, type LucideIcon } from 'lucide-react';

const SitemapSection = ({ title, links }: { title: string, links: Array<{ path: string, label: string, icon: LucideIcon }> }) => (
