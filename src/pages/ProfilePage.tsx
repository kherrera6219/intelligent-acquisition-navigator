...
import { 
  ...
  BellRing, CheckCircle, AlertCircle, Plus, Download 
} from "lucide-react";
      ...
      <div className="min-h-[calc(100vh-200px)]">
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="col-span-1 p-6 bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700">
            ...
            <Card className="col-span-1 lg:col-span-2 p-6 bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700">
          ...
          <Card className="mt-6 p-6 bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700">
