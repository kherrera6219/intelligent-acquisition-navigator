    ...
    <div className="relative overflow-hidden rounded-xl">
      ...
      <div className="relative z-10 py-16 md:py-24 px-6 max-w-5xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-4">
          <span className="bg-gradient-to-r from-[#9b87f5] via-[#D946EF] to-[#F97316] bg-clip-text text-transparent inline-block mb-2">
            Powerful Features
          </span>{" "}
          <span className="text-lg md:text-xl lg:text-2xl block mt-2">
            for Modern Acquisition
          </span>
        </h1>
        
        <div className="text-6xl md:text-7xl lg:text-8xl text-[#9b87f5] mb-6 font-bold tracking-wider filter drop-shadow-[0_2px_8px_rgba(155,135,245,0.6)] mix-blend-luminosity">
          ProcurityIQ
        </div>
        
        <p className="text-lg text-white/80 max-w-3xl mx-auto mb-8 bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent font-medium">
        ...
        <div className="inline-flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <button className="bg-white/10 hover:bg-white/20 text-white border border-[#9b87f5]/20 px-6 py-3 rounded-lg font-medium transition-colors backdrop-blur-sm">
            Schedule Demo
          </button>
        </div>
      </div>
